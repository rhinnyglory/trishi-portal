                ...
                <div className="row authenticate-form">
                        ...
                        <div className="row">
                            <div className="col-md-6 offset-3">
                                <div className=" form-group mb-3">
                                    <Controller name="mobileNumber" control={control1} rules={{ required: { value: true, message: "Please enter the Mobile Number." } }} render={({ field }) => <input className="form-control" placeholder="Enter mobile number *" {...field} />} />
                    ...
                    <form onSubmit={handleSubmit2(onSubmitForm2)}>
                        <div className="row mt-4">
                            <div className="col-md-6 offset-3">
                                <div className=" form-group">
                                    <Controller name="otp" control={control2} rules={{ required: { value: true, message: "Please enter the OTP." } }} render={({ field }) => <input className="form-control" disabled={openOTP} placeholder="Enter Otp *" {...field} />} />
